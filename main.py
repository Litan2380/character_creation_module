...
def attack(char_name: str, char_class: str) -> str:
    """Выбор класса символа для функции атака."""
...
def defence(char_name: str, char_class: str) -> str:
    """Выбор класса символа для функции защита."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Выбор класса символа для функции особенный."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Выбор класса символа для функции старт тренировки."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбор класса символа для функции выбор класса символа."""
    approve_choice: str = ''
    char_class: str = ''
